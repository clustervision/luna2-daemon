...
class OsUser():
    ...
    def __init__(self):
        ...
        self.osuser_plugins = Helper().plugin_finder('/trinity/local/luna/plugins/osuser')  # needs to be with constants. pending
    ...
    def update_user(self, username, request):
        ...
        try:
            ...
            results=OsUserPlugin().update_user(username=userinfo['username'],
    ...
    def update_group(self, groupname, request):
        ...
        try:
            ...
            results=OsUserPlugin().update_groups(groupname=groupinfo['groupname'],
