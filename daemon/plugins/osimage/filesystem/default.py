...
class Plugin():
    ...
    def sync(self,remote_host=None, remote_image_directory=None, osimage=None, local_image_directory=None):
        ...
        if remote_host and remote_image_directory and osimage and local_image_directory:
            ...
            command=f"rsync -aHv --numeric-ids --one-file-system --delete-after --exclude=/proc/ --exclude=/dev/ --exclude=/sys/ {remote_host}:{remote_image_directory}/* {local_image_directory}/ > /tmp/syncimage.out"
