...
def boot_install(node=None):
    ...
    return render_template_string(
        ...
        LUNA_API_PORT           = data['serverport'],
        LUNA_API_PROTOCOL       = data['protocol'],
        LUNA_API_USERNAME       = data['username'],
        LUNA_API_PASSWORD       = data['password'],
        VERIFY_CERTIFICATE      = data['verify_certificate'],
        WEBSERVER_PORT          = data['webserver_port'],
        WEBSERVER_PROTOCOL      = data['webserver_protocol'],
        LUNA_LOGHOST            = data['loghost'],
        ...
        LUNA_HOLD_SECONDS       = data['hold_seconds'],
        LUNA_HOLD_REASON        = data['hold_reason'],
        LUNA_BMC                = data['bmc'],
        LUNA_ROLES              = data['roles'],
        LUNA_PROFILES           = data['profiles'],
        ...
        LUNA_INSTALL_MODE       = data.get('install_mode', 'auto'),
        LUNA_DISKLAYOUT_B64     = data.get('disklayout', ''),
        LUNA_OSIMAGE_FILTER_B64 = data.get('osimage_filter', ''),
        LUNA_MOUNTS_FSTAB_B64   = data.get('mounts_fstab', ''),
        LUNA_MOUNTS_EXPORTS_B64 = data.get('mounts_exports', ''),
        LUNA_MOUNTS_DIRS_B64    = data.get('mounts_dirs', ''),
