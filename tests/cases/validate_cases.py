...
CASES = [
    ...
    {"id": "structure-text-where-a-level-belongs", "func": check_structure,
     "args": [{"a": "b c"}, "a:b"], "expected": False},
    # --- check_structure with object_at_end: the path leads to the object a route reads ---
    {"id": "structure-object-dict", "func": check_structure,
     "args": [{"config": {"node": {"n1": {"comment": "x"}}}}, "config:node:n1"],
     "kwargs": {"object_at_end": True}, "expected": True},
    {"id": "structure-object-list", "func": check_structure,
     "args": [{"config": {"secrets": {"node": {"n1": [{"name": "s"}]}}}}, "config:secrets:node:n1"],
     "kwargs": {"object_at_end": True}, "expected": True},
    {"id": "structure-object-is-text", "func": check_structure,
     "args": [{"config": {"node": {"n1": "x"}}}, "config:node:n1"],
     "kwargs": {"object_at_end": True}, "expected": False},
    {"id": "structure-object-is-number", "func": check_structure,
     "args": [{"config": {"node": {"n1": 1}}}, "config:node:n1"],
     "kwargs": {"object_at_end": True}, "expected": False},
]
