...
BLESSED_CLASSIC_ADDITIONS = [
    ...
    # and stacked. Applied at install time; renders into the flow only for a node
    # that has profiles assigned, so everyone else keeps the exact old installer.
    ...
    '',
    '        rm -f /lunatmp/node.profile.content*.dat',
    '        TEL=0',
